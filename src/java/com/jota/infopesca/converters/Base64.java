 ...
 * Victoria, BC Canada V8V 2Y5 tel:(250) 361-9093 <a
 * href="mailto:roedy@mindprod.com">mailto:roedy@mindprod.com</a>
 */
/**
 ...
 * Software Ltd. <a href="http://www.optrak.co.uk">http://www.optrak.co.uk</a>
 * and Kevin Kelley's <a
 * href="http://www.ruralnet.net/~kelley/java/Base64.java">http://www.ruralnet.net/~kelley/java/Base64.java</a>
 * 
* Base64 is a way of encoding 8-bit characters using only ASCII printable
 * characters sometimes called UUENCODE The spec is described in RFC 2045.
 * Base64 is a scheme where 3 bytes are concatenated, then split to form 4
 * groups of 6-bits each; and each 6-bits gets translated to an encoded
 * printable ASCII character, via a table lookup. An encoded string is therefore
 * longer than the original by about 1/3. The "=" character is used to pad the
 * end. Base64 is used, among other things, to encode the user:password string
 * in an Authorization: header for HTTP. Don't confuse Base64 with
 * x-www-form-urlencoded which is handled by Java.net.URLEncoder.encode/decode
 * If you don't like this code, there is another implementation at <a
 * href="http://www.ruffboy.com/download.htm">http://www.ruffboy.com/download.htm</a>
 * Sun has an undocumented method called sun.misc.Base64Encoder.encode. You
 * could use hex, simpler to code, but not as compact.
 * 
...
public class Base64 {
     ...
     */
    private int lineLength = 1024 * 100;
